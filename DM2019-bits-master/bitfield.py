...
class BitField(object):
    ...
    def __init__(self, from_bit: int, to_bit: int) -> None:
        ...
        mask = 0
        self.mask_len = self.to_bit - self.from_bit + 1
    ...
    def extract(self, word: int) -> int:
        ...
        """
        stored_word = word >> self.from_bit
        extracted = self.mask & stored_word
        return extracted
